...
class Role extends SpatieRole
{
    ...
    {
        return $this->usersInStores()
            ->wherePivot('store_id', (int) $store->id)
            ->wherePivot('is_active', true);
    }

    public function lowerRolesInStore(int $storeId)
    {
    ...
    public function higherRolesInStore(int $storeId)
    {
    ...
    public function isHigherThan(Role $otherRole, int $storeId): bool
    {
        return $this->getAllLowerRolesForStore($storeId)->contains('id', $otherRole->id);
    }

    public function getAllPermissionsForStore(int $storeId): \Illuminate\Support\Collection
    {
